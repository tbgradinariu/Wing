...
@class SharedSet, SharedExercise, SharedKotlinArray<T>, SharedLifecycle_viewmodelViewModel, SharedKmp_observableviewmodel_coreViewModel, SharedWeightType, SharedKotlinEnumCompanion, SharedKotlinEnum<E>, SharedKotlinx_datetimeLocalDate, SharedWorkout, SharedNextWorkoutViewModel, SharedKotlinUnit, NSError, SharedKotlinx_datetimeMonth, SharedKotlinx_datetimeLocalDateCompanion, SharedKotlinx_datetimeDayOfWeek, SharedKotlinx_datetimePadding, SharedKotlinx_datetimeDayOfWeekNames, SharedKotlinx_datetimeMonthNames, SharedKotlinx_datetimeDayOfWeekNamesCompanion, SharedKotlinx_datetimeMonthNamesCompanion, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedKotlinNothing;

@protocol SharedPlatform, SharedKotlinAutoCloseable, SharedKotlinx_coroutines_coreCoroutineScope, KMPOVMViewModelScope, SharedKotlinComparable, SharedKotlinIterator, SharedKotlinCoroutineContext, SharedKotlinCoroutineContextElement, SharedKotlinCoroutineContextKey, SharedKotlinx_datetimeDateTimeFormat, SharedKotlinx_datetimeDateTimeFormatBuilderWithDate, SharedKotlinx_serialization_coreKSerializer, SharedKotlinAppendable, SharedKotlinx_datetimeDateTimeFormatBuilder, SharedKotlinx_serialization_coreEncoder, SharedKotlinx_serialization_coreSerialDescriptor, SharedKotlinx_serialization_coreSerializationStrategy, SharedKotlinx_serialization_coreDecoder, SharedKotlinx_serialization_coreDeserializationStrategy, SharedKotlinx_serialization_coreCompositeEncoder, SharedKotlinAnnotation, SharedKotlinx_serialization_coreCompositeDecoder, SharedKotlinx_serialization_coreSerializersModuleCollector, SharedKotlinKClass, SharedKotlinKDeclarationContainer, SharedKotlinKAnnotatedElement, SharedKotlinKClassifier;
...
@interface SharedExercise : SharedBase
- (instancetype)initWithName:(NSString *)name sets:(NSArray<SharedSet *> *)sets __attribute__((swift_name("init(name:sets:)"))) __attribute__((objc_designated_initializer));
- (SharedExercise *)doCopyName:(NSString *)name sets:(NSArray<SharedSet *> *)sets __attribute__((swift_name("doCopy(name:sets:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *name __attribute__((swift_name("name")));
@property (readonly) NSArray<SharedSet *> *sets __attribute__((swift_name("sets")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("NextWorkoutViewModel")))
@interface SharedNextWorkoutViewModel : SharedKmp_observableviewmodel_coreViewModel
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
- (void)getNextWorkout __attribute__((swift_name("getNextWorkout()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Set")))
@interface SharedSet : SharedBase
- (instancetype)initWithReps:(int32_t)reps weight:(float)weight weightType:(SharedWeightType *)weightType __attribute__((swift_name("init(reps:weight:weightType:)"))) __attribute__((objc_designated_initializer));
- (SharedSet *)doCopyReps:(int32_t)reps weight:(float)weight weightType:(SharedWeightType *)weightType __attribute__((swift_name("doCopy(reps:weight:weightType:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int32_t reps __attribute__((swift_name("reps")));
@property (readonly) float weight __attribute__((swift_name("weight")));
@property (readonly) SharedWeightType *weightType __attribute__((swift_name("weightType")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WeightType")))
@interface SharedWeightType : SharedKotlinEnum<SharedWeightType *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) SharedWeightType *bodyweight __attribute__((swift_name("bodyweight")));
@property (class, readonly) SharedWeightType *weighted __attribute__((swift_name("weighted")));
+ (SharedKotlinArray<SharedWeightType *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<SharedWeightType *> *entries __attribute__((swift_name("entries")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Workout")))
@interface SharedWorkout : SharedBase
- (instancetype)initWithName:(NSString *)name date:(SharedKotlinx_datetimeLocalDate *)date exercises:(NSArray<SharedExercise *> *)exercises __attribute__((swift_name("init(name:date:exercises:)"))) __attribute__((objc_designated_initializer));
- (SharedWorkout *)doCopyName:(NSString *)name date:(SharedKotlinx_datetimeLocalDate *)date exercises:(NSArray<SharedExercise *> *)exercises __attribute__((swift_name("doCopy(name:date:exercises:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedKotlinx_datetimeLocalDate *date __attribute__((swift_name("date")));
@property (readonly) NSArray<SharedExercise *> *exercises __attribute__((swift_name("exercises")));
@property (readonly) NSString *name __attribute__((swift_name("name")));
@end

@interface SharedNextWorkoutViewModel (Extensions)
@property (readonly) SharedKotlinUnit *(^(^workoutFlow)(SharedKotlinUnit *(^)(SharedWorkout * _Nullable, SharedKotlinUnit *(^)(void), SharedKotlinUnit *), SharedKotlinUnit *(^)(NSError * _Nullable, SharedKotlinUnit *), SharedKotlinUnit *(^)(NSError *, SharedKotlinUnit *)))(void) __attribute__((swift_name("workoutFlow")));
@property (readonly) SharedWorkout * _Nullable workout __attribute__((swift_name("workout")));
@end
