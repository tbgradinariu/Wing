...
@NonNullApi
public class WingProjectDependency extends DelegatingProjectDependency {

    @Inject
    public WingProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
